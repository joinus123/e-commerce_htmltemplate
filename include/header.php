                  ...
                  <div class="col-md-10">
                     <div class="top-header-sec2 pull-right">
                        <ul class="list-inline">
                           <li class="list-inline-item"><a href="login.php"><img src="assets/images/top-header-img-2.png"> &nbsp; log in</a> / <a href="signup.php">sign up</a></li>
                           <li class="list-inline-item"><a href="dashboard.php"><img src="assets/images/top-header-img-3.png"> &nbsp;my account</a></li>
                           <li class="list-inline-item"><a href="aboutus.php"><img src="assets/images/top-header-img-4.png"> &nbsp; about us</a></li>
                           <li class="list-inline-item"><a href="#"><img src="assets/images/top-header-img-5.png"> &nbsp; blog</a></li>
                           <li class="list-inline-item"><a href="videos.php"><img src="assets/images/top-header-img-6.png"> &nbsp; videos</a></li>
                           ...
                           <li class="list-inline-item"><a href="order-status.php"><img src="assets/images/top-header-img-8.png"> &nbsp; order status</a></li>
                           <li class="list-inline-item"><i class="fa fa-heart heart" aria-hidden="true"></i><a href="wishlist.php"> &nbsp; wishlist</a></li>
                        </ul> 
                     </div>
            ...
            <div class="container-fluid">
               ...
               <div class="col-md-12">
                  <div class="navigation-list text-center">
                     <ul class="list-inline">
                        <li class="list-inline-item"><a href="all-products.php" data-aos="zoom-in-up" data-aos-duration="1200">all products</a></li>
                        <li class="list-inline-item"><a href="arm-health.php" data-aos="zoom-in-up" data-aos-duration="1200">arm care</a></li>
                        <li class="list-inline-item"><a href="condition-recovery.php" data-aos="zoom-in-up" data-aos-duration="1200">condition & recover</a></li>
                        <li class="list-inline-item"><a href="mobility-flexibility.php" data-aos="zoom-in-up" data-aos-duration="1200">mobility & flexibility</a></li>
                        <li class="list-inline-item"><a href="strength-stability.php" data-aos="zoom-in-up" data-aos-duration="1200">strength & stability</a></li>
                        <li class="list-inline-item"><a href="velocity-enhancement.php" data-aos="zoom-in-up" data-aos-duration="1200">velocity enhancement</a></li>
                        <li class="list-inline-item"><a href="wake-up-warm-up.php" data-aos="zoom-in-up" data-aos-duration="1200">wake-up warm-up</a>
                        </li>
                     </ul>
                  </div>
               </div>
